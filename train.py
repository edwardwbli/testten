...
def main():
        ...
        classifier = tf.contrib.learn.DNNClassifier(feature_columns=feature_columns,hidden_units=[1024, 512, 256],n_classes=5,
						    optimizer=tf.train.ProximalAdagradOptimizer(learning_rate=0.1,l1_regularization_strength=0.001),
						    model_dir="/tmp/customer_model5")
        ...
        def new_samples():
		customer1 = np.random.random((1,12))*500
